  ...
  if (type === "anime") {
    if (setting === "scifi") {
      ...
      recommendation = {
        ...
        description:
          "Jujutsu Kaisen is a Japanese anime television series produced by MAPPA, based on Gege Akutami's manga series. The story follows high school student Yuji Itadori as he joins a secret organization of Jujutsu Sorcerers to eliminate a powerful Curse named Ryomen Sukuna, of whom Yuji becomes the host.",
      };
    } else {
      recommendation = {
    ...
    if (setting === "scifi") {
      ...
      recommendation = {
        ...
        description:
          "Brooklyn Nine-Nine is a comedy television series that follows the lives and investigations of a detective squad within the fictional 99th Precinct of the New York City Police Department, located in Brooklyn. The show revolves around the humor, camaraderie, and sometimes surprising personalities of the characters as they navigate their jobs and personal lives.",
      };
      ...
      recommendation = {
        ...
        description:
          "In this contemporary version of Sir Arthur Conan Doyle's detective stories, Dr. John Watson is a war vet just home from Afghanistan. He meets the brilliant but eccentric Holmes when the latter, who serves as a consultant to Scotland Yard, advertises for a flatmate.",
      };
      ...
      recommendation = {
        ...
        description:
          "Game of Thrones describes a long struggle for power between noble families while a threat looms over their kingdoms, an external enemy that destroys everything in its path: the White Walkers. The series takes place on two continents, Westeros to the west, and Essos to the east.",
      };
    } else {
      recommendation = {
